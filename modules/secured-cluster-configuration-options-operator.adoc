...
| If you set this option to `Disabled`, {product-title} disables autoscaling on the Scanner deployment. Defaults to `Enabled`.
...
| The default number of replicas. Defaults to 3.
...
| If you set this option to `Disabled`, {product-title} does not deploy the Scanner deployment. This should not generally be disabled on OpenShift clusters. Defaults to `AutoSense`.
