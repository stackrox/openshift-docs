...
[role="_abstract"]
The {product-title} ({product-title-short}) dashboard enables you to visually track and analyze key metrics such as risk across your environment, compliance status, and policy violations.
...
[NOTE]
====
When you open the {product-title-short} portal for the first time, you might see a blank dashboard.
